...
$guide_title   = 'Hexagon Lattice';
$guide_prev    = ['href' => 'studio-triangle.php', 'title' => 'Triangle Lattice'];
$guide_next    = ['href' => 'drawing.php', 'title' => '도면 저장 & 불러오기'];
include __DIR__ . '/_head.php';
?>

<h1>Hexagon Lattice</h1>
<p class="guide-lead">
    Triangle Lattice에서 수직 방향(0°) 살을 제거해 육각형(육모살) 셀을 형성하는 패턴입니다.
    벌집 구조처럼 60°·120° 두 방향 사선살만으로 구성되어 독특하고 우아한 느낌을 줍니다.
</p>

<h2>Triangle과의 차이</h2>
<table class="guide-table">
    <thead><tr><th></th><th>Triangle Lattice</th><th>Hexagon Lattice</th></tr></thead>
    <tbody>
