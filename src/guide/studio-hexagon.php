...
<h1><span class="guide-h1-icon"><?= $guideEngineIcons['hexagon'] ?></span>육모솟을살</h1>
<p class="guide-lead"><?= studio_card_description('hexagon', "세모솟을살과 같은 세 방향 살대를 쓰되, 교차점을 한 점에 모으지 않고 어긋나게 짜 육각형이 열리도록 한 육모솟을살을 재현한 엔진입니다.
    어금육모라고도 부릅니다.
