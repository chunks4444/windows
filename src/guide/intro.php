...
<h1>워크그룹 평목이란?</h1>
<p class="guide-lead">
    워크그룹 평목(平木)은 전통 한국 창호 도면을 브라우저에서 실시간으로 설계하고 내보낼 수 있는 온라인 스튜디오입니다.
    별도 프로그램 설치 없이 6가지 격자 패턴 엔진과 AI 렌더링 기능을 사용할 수 있습니다.
</p>

<h2>주요 기능</h2>
<p>워크그룹 평목이 제공하는 핵심 기능을 소개합니다.</p>
...
<table class="guide-table">
    ...
    <tbody>
        <tr><td><strong>6가지 스튜디오</strong></td><td>세살, 정자살, 빗살, 격자빗살, 세모솟을살, 육모솟을살 격자 패턴 엔진</td></tr>
...
<ul>
    ...
    <li><strong>격자빗살</strong> — 마름모 복합 패턴. 수직·수평·사선이 결합된 고급 패턴</li>
    <li><strong>세모솟을살</strong> — 삼각 격자. 0°·60°·120° 세 방향 살로 구성</li>
    <li><strong>육모솟을살</strong> — 육각 격자. 삼각에서 한 방향을 제거한 육모살 패턴</li>
</ul>
...
<h2>시스템 요구 사항</h2>
<p>워크그룹 평목은 웹 브라우저에서 동작하는 서비스입니다. 별도 설치 없이 아래 환경에서 사용 가능합니다.</p>
<ul>
