      ...
      <tr>
        <td style="padding:36px 32px 24px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
            ...
            <tr>
              <td style="width:72px;padding:10px 0;border-bottom:1px solid #f0f2f1;font-size:12px;color:#97A8A6;font-weight:600;vertical-align:top;">연락처</td>
              <td style="padding:10px 0 10px 16px;border-bottom:1px solid #f0f2f1;font-size:14px;color:#1A1F1E;"><?= htmlspecialchars($phone) ?></td>
            </tr>
            <?php if (!empty($company)): ?>
            <tr>
              <td style="width:72px;padding:10px 0;border-bottom:1px solid #f0f2f1;font-size:12px;color:#97A8A6;font-weight:600;vertical-align:top;">회사명</td>
              <td style="padding:10px 0 10px 16px;border-bottom:1px solid #f0f2f1;font-size:14px;color:#1A1F1E;"><?= htmlspecialchars($company) ?></td>
            </tr>
            <?php endif; ?>
            <?php if (!empty($email)): ?>
            <tr>
            ...
            <?php if (!empty($memo)): ?>
            <tr>
              <td style="width:72px;padding:14px 0;font-size:12px;color:#97A8A6;font-weight:600;vertical-align:top;">요청사항</td>
              <td style="padding:14px 0 0 16px;font-size:14px;color:#1A1F1E;line-height:1.8;white-space:pre-wrap;"><?= htmlspecialchars($memo) ?></td>
            </tr>
            <?php endif; ?>
          </table>
        </td>
