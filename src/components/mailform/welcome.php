    ...
    <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;max-width:560px;">
      ...
      <tr>
        <td style="padding:36px 32px 24px;">
          <p style="font-size:20px;font-weight:700;color:#1A1F1E;margin:0 0 16px;letter-spacing:-0.5px;">가입을 환영합니다!</p>
          <p style="font-size:14px;color:#5A6B69;line-height:1.8;margin:0 0 12px;">안녕하세요,<br>평목 스튜디오에 오신 것을 환영합니다.</p>
          <p style="font-size:14px;color:#5A6B69;line-height:1.8;margin:0 0 28px;">
            가입하신 이메일 주소는 <strong style="color:#1A1F1E;"><?= htmlspecialchars($email) ?></strong>입니다.<br>
