    ...
    <table width="560" cellpadding="0" cellspacing="0" style="background:var(--bg);border-radius:12px;overflow:hidden;max-width:560px;">
      ...
      <tr>
        <td style="padding:36px 32px 24px;">
          <p style="font-size:20px;font-weight:700;color:var(--text);margin:0 0 20px;letter-spacing:-0.5px;">새 문의가 도착했습니다</p>
          <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
            ...
            <tr>
              <td style="width:72px;padding:10px 0;border-bottom:1px solid var(--bg);font-size:12px;color:var(--text-muted);font-weight:600;vertical-align:top;">제목</td>
              <td style="padding:10px 0 10px 16px;border-bottom:1px solid var(--bg);font-size:14px;color:var(--text);"><?= htmlspecialchars($subject) ?></td>
            </tr>
            <tr>
