...
<div class="db-page" id="oauthPage" style="display:none;">
    <div class="adm-breadcrumb"><a href="/src/admin/">어드민</a><span class="adm-breadcrumb-sep">/</span>SNS 로그인 설정</div>
    <div class="db-header">
    ...
    <div style="max-width:600px;margin:0 auto;">
        ...
        <div class="oauth-card">
            ...
            <div class="oauth-callback">Redirect URI: https://pyeongmok.com/src/api/auth/oauth/callback.php?provider=google</div>
        ...
        <div class="oauth-card">
            ...
            <div class="oauth-callback">Redirect URI: https://pyeongmok.com/src/api/auth/oauth/callback.php?provider=kakao</div>
            <div class="oauth-field">
        ...
        <div class="oauth-card">
            ...
            <div class="oauth-callback">Redirect URI: https://pyeongmok.com/src/api/auth/oauth/callback.php?provider=naver</div>
            <div class="oauth-field">
                <label>Client ID</label>
