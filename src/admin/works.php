...
<?php css_tag('/src/css/dashboard.css'); ?>
    ...
    <style>
        ...
        .work-thumb-empty { width:80px; height:60px; border-radius:4px; background:var(--bg); display:flex; align-items:center; justify-content:center; color: var(--text); font-size:18px; }
...
<div class="adm-modal-overlay" id="worksModalOverlay">
    <div class="adm-modal" style="max-width:520px;">
        ...
        <div class="adm-modal-body">
            ...
            <div class="adm-mfield">
                ...
                <div style="display:flex;gap:16px;align-items:center;flex-wrap:wrap;">
                    <label style="font-size:11px;color: var(--text);display:flex;align-items:center;gap:6px;">
                        배경
        ...
        <div id="multiImgSection" style="display:none;border-top:1px solid var(--border);padding:16px 24px 16px;margin:0;overflow:hidden;">
            <div style="font-size:12px;font-weight:600;color: var(--text);margin-bottom:10px;">슬라이드 이미지</div>
...
function renderTags() {
    document.getElementById('tagList').innerHTML = tags.map(t => `
        <div style="display:inline-flex;align-items:center;gap:6px;padding:5px 10px;border-radius:999px;
            ...
            <button onclick="openTagModal(${t.id})" style="border:none;background:none;cursor:pointer;color: var(--text);padding:0;font-size:13px;line-height:1;" title="수정">✎</button>
            <button onclick="toggleTag(${t.id})" style="border:none;background:none;cursor:pointer;color: var(--text);padding:0;font-size:12px;line-height:1;" title="${t.is_active ? '숨김' : '표시'}">${t.is_active ? '●' : '○'}</button>
