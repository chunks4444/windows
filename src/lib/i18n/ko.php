...
return [
    ...
    // 빛과 살 — Philosophy 바로 아래 산문 섹션
    'company_light_label'      => '빛과 살',
    'company_light_title'      => '한옥 창호는 빛을 막지 않고<br>나누어 들입니다',
    'company_light_p1a'        => '유리창은 빛을 통째로 들이고, 벽은 통째로 막습니다. 살은 그 사이에 있습니다. 막으면서 들이고, 들이면서 거릅니다.',
    'company_light_p1b'        => '살 간격이 촘촘하면 빛이 잘게 부서져 방 안이 고르게 밝아집니다. 성기면 덩어리로 들어와 바닥에 또렷한 그림자를 남깁니다. <b>같은 문양이라도 창이 앉는 방향과 시간에 따라 다르게 보입니다.</b>',
    'company_light_p2a'        => '그래서 옛 목수는 방마다 살을 달리 짰습니다. 안방과 대청이 같을 수 없고, 남향과 북향이 같을 수 없습니다.',
    'company_light_p2b'        => '스튜디오에서 살 간격을 옮기는 일은 무늬를 고르는 일처럼 보이지만, 실은 그 방에 들어올 빛을 정하는 일입니다.',
    ...
    'col_share'               => '공유하기',
    'col_copy'                => '복사',
    'col_share_kakao'         => '카카오톡 공유',
    'col_kakao'               => '카카오',
    'col_share_fb'            => '페이스북 공유',
    'col_share_x'             => 'X(트위터) 공유',
    'col_share_threads'       => '스레드에 공유',
    'col_threads'             => '스레드',
    'col_open'                => '열기',
