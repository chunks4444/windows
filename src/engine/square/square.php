...
$cfg = get_engine_settings('square');
...
<body class="pm-generator">
    ...
    <?php $blogEngineKey = 'square'; include __DIR__ . '/../../components/blog_engine_link.php'; ?>
            ...
            <div class="sb-inner">
                ...
                <div class="sb-section">
                    ...
                    <div class="ctrl">
                        ...
                        <div class="slider-row">
                            <input type="range" id="txtRatio" min="1.0" max="3.0" step="0.1" value="<?= htmlspecialchars($cfg['ratio']) ?>">
                            <input type="number" class="slider-num" id="numRatio" min="1.0" max="3.0" step="0.1" value="<?= htmlspecialchars($cfg['ratio']) ?>">
                        </div>
                    </div>
                    </div>
