...
<body class="pm-generator">
    ...
    <?php $blogEngineKey = 'triangle'; include __DIR__ . '/../../components/blog_engine_link.php'; ?>
    ...
    <div class="main">
        ...
        <div class="controls" id="sidebar">
            <div class="sb-inner">
                ...
                <div class="sb-section">
                    ...
                    <hr class="sb-divider">
                    <div class="ctrl">
                        <div class="ctrl-header"><span class="ctrl-label" id="lblCols"><?= te('가로 칸수') ?></span></div>
                        <div class="slider-row">
                            <input type="range" id="txtCols" min="2" max="30" step="2" value="<?= htmlspecialchars($cfg['cols']) ?>">
                            <input type="number" class="slider-num" id="numCols" min="2" max="30" step="2" value="<?= htmlspecialchars($cfg['cols']) ?>">
                        </div>
                    </div>
                    <hr class="sb-divider">
                    ...
                    <hr class="sb-divider">
                    <div class="toggle-row">
                        <span class="toggle-label"><?= te('패턴 세로 방향') ?></span>
                        <label class="toggle-switch">
                ...
                <div class="sb-section sb-collapsed">
                    ...
                    <div class="slat-group">
                        <div class="slat-group-title" id="dirSlatGroupTitle"><?= te('가로부재') ?></div>
                        <div class="slat-row">
                    ...
                    <div class="slat-group">
                        <div class="slat-group-title"><?= te('사선살') ?></div>
        ...
        <div class="canvas-area" id="canvasContainer">
            ...
            <div class="canvas-controls">
                ...
                <div class="cv-sep"></div>
                <button class="cv-btn" id="btnEditDelete" title="<?= te('선 삭제 클릭 → 선 삭제 다시 클릭 → 복구') ?>">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <button class="cv-btn" id="btnEditAdd" title="<?= te('선 추가 ① 시작 교점 클릭 ② 끝 교점 클릭 → 선 완성') ?>">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M12 20h9"/>
                        <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/>
                    </svg>
                </button>
                <button class="cv-btn" id="btnEditClear" title="<?= te('편집 초기화 모든 삭제·추가 선 초기화') ?>">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
