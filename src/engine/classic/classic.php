            ...
            <div class="sb-inner">
                    ...
                    <div id="ratioCtrl">
                        ...
                        <div style="display:flex;gap:6px;align-items:center;">
                            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex:1;">
                                <span style="font-size:var(--fs-12);color:var(--text-muted);font-weight:600;">가로살 상</span>
                            ...
                            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex:1;">
                                <span style="font-size:var(--fs-12);color:var(--text-muted);font-weight:600;">가로살 중</span>
                            ...
                            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex:1;">
                                <span style="font-size:var(--fs-12);color:var(--text-muted);font-weight:600;">가로살 하</span>
                ...
                <div class="sb-section sb-collapsed">
                    ...
                    <div class="spec-grid">
                        ...
                        <div class="spec-card">
                            <div class="spec-lbl">세로 내경중심</div>
