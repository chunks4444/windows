...
<body>
    ...
    const txtFrameTop = document.getElementById('txtFrameTop');
    const txtFrameBottom = document.getElementById('txtFrameBottom');
    const txtFrameLeft = document.getElementById('txtFrameLeft');
    const txtFrameRight = document.getElementById('txtFrameRight');
